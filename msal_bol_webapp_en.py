...
def header_layout(canvas, doc, data):
    ...
    try:
        ...
        # اسم الشركة باللون الأزرق الداكن
    ...
    # 4. رقم المستند (5) - العنوان بالأزرق الداكن
...
def generate_bl_pdf(data):
    ...
    # دالة مساعدة لإنشاء الفقرات بالعنوان الأزرق الداكن
    def create_blue_label_paragraph(label_text, data_key):
        content = data.get(data_key, '')
        # يتم تطبيق اللون الأزرق الداكن (DarkBlue) على العنوان الأساسي
        return Paragraph(f'<font color="DarkBlue"><b>{label_text}</b></font><br/>{content}', styles['Normal'])
    
    # --- القسم العلوي (Parties) ---
    data_upper = [
        [
            create_blue_label_paragraph("(2) Shipper / Exporter", '(2) Shipper'), 
            create_blue_label_paragraph("(6) Export References", '(6) Export References'),
        ],
        [
            create_blue_label_paragraph("(3) Consignee (complete name and address)", '(3) Consignee'), 
            create_blue_label_paragraph("(7) Forwarding Agent-References", '(7) Forwarding Agent'),
        ],
        [
            create_blue_label_paragraph("(4) Notify Party (complete name and address)", '(4) Notify Party'), 
            create_blue_label_paragraph("(8) Point and Country of Origin", '(8) Point and Country'),
        ],
        ['', create_blue_label_paragraph("(9) Also Notify Party (complete name and address)", '(9) Also Notify Party')],
    ]
    ...
    data_middle = [
        [
            create_blue_label_paragraph("(12) Imo Vesselle No.", '(12) Imo Vesselle No.'), 
            create_blue_label_paragraph("(13) Place of Receipt/Date", '(13) Place of Receipt/Date'),
            create_blue_label_paragraph("(10) Onward Inland Routing/Export Instructions", '(10) Onward Inland Routing')
        ],
        [
            create_blue_label_paragraph("(14) Ocean Vessel/Voy. No.", '(14) Ocean Vessel/Voy. No.'), 
            create_blue_label_paragraph("(15) Port of Loading", '(15) Port of Loading'),
            create_blue_label_paragraph("(16) Port of Discharge", '(16) Port of Discharge')
        ],
        [
            create_blue_label_paragraph("(16) Port of Discharge (Repeat)", '(16) Port of Discharge (Repeat)'),
            create_blue_label_paragraph("(17) Place of Delivery", '(17) Place of Delivery'),
            create_blue_label_paragraph("(11) Ocean Freight Rate (for Merchant's reference)", '(11) Ocean Freight Rate'),
        ]
    ]
    ...
    Story.append(Paragraph('<br/><font color="DarkBlue"><b>Particulars furnished by the Merchant</b></font>', styles['Normal']))

    data_goods = [
        # صف العناوين (Headers) - باللون الأزرق الداكن
        [
            Paragraph('<font color="DarkBlue"><b>(18) Container No. And Seal No. Marks & Nos.</b><br/>CONTAINER NO./SEAL NO.</font>', styles['Normal']),
            Paragraph('<font color="DarkBlue"><b>(19) Quantity And Kind of Packages</b></font>', styles['Normal']),
            Paragraph('<font color="DarkBlue"><b>(20) Description of Goods</b></font>', styles['Normal']),
            Paragraph('<font color="DarkBlue"><b>(21) Measurement (M³) Gross Weight (KGS)</b></font>', styles['Normal']),
        ],
        # صف البيانات (Data) - بالأسود
        [
    ...
    data_lower = [
        [
            create_blue_label_paragraph("(22) TOTAL NUMBER OF CONTAINERS OR PACKAGES (IN WORDS)", '(22) Total in Words'),
            create_blue_label_paragraph("(24) FREIGHT & CHARGES", '(24) FREIGHT & CHARGES'), 
            'Revenue Tons', 'Rate', 'Per Prepaid', 'Collect',
        ],
        [
            create_blue_label_paragraph("(25) B/L NO.", '(25) B/L No.'), 
            create_blue_label_paragraph("(27) Number of Original B(s)/L", '(27) Number of Original'), 
            create_blue_label_paragraph("(29) Prepaid at", '(29) Prepaid at'), 
            create_blue_label_paragraph("(30) Collect at", '(30) Collect at'),
            create_blue_label_paragraph("Signature/Stamp:", 'Digital Signature'), # حقل الإضافة
        ],
        [
            create_blue_label_paragraph("(26) Service Type/Mode", '(26) Service Type'), 
            create_blue_label_paragraph("(33) Laden on Board", '(33) Laden on Board'), 
            create_blue_label_paragraph("(28) Place of B(s)/L Issue/Date", '(28) Place of Issue'), 
            create_blue_label_paragraph("(31) Exchange Rate", '(31) Exchange Rate'),
            create_blue_label_paragraph("(32) Exchange Rate", '(32) Exchange Rate (Repeat)'),
        ]
    ]
...
st.title("🚢 نظام إنشاء بوليصة الشحن الإلكترونية (B/L)")
st.caption("أدخل البيانات اللازمة لإنشاء مستند PDF. النمط: العناوين باللون الأزرق الداكن والبيانات بالأسود.")
...
if submitted:
    ...
    try:
        ...
        st.success("تم إنشاء الملف بنجاح! تم تطبيق اللون الأزرق الداكن على العناوين.")
